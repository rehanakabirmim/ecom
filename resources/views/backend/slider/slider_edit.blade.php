							...
							<div class="card-body">
                                ...
                                <div class="row mb-3">
									...
									<div class="form-group col-sm-9 text-secondary">
										...
										<input type="text" class="form-control" id="short_title" name="short_title" value="{{ $slider->short_title}}">
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
									<img id="showImage" src="{{ asset(str_replace('public/', '', $slider->slider_image)) }}"
