					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Edit Bannerr</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
							...
							<div class="card-body">
								...
								<div class="row mb-3">
									...
									<div class="form-group col-sm-9 text-secondary">
										...
										<input type="text" class="form-control" id="	banner_title" name="banner_title" value={{$banners-> banner_title}}>
									</div>
								</div>
                                ...
                                <div class="row mb-3">
									...
									<div class="form-group col-sm-9 text-secondary">
										...
										<input type="text" class="form-control" id="banner_url" name="banner_url" value="{{$banners->banner_url }}">
									</div>
								</div>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
									<img id="showImage" src="{{ asset(str_replace('public/', '', $banners->banner_image)) }}"
										alt="Slider" style="width: 100px; height: 100px;">
