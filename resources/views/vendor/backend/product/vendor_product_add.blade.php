        ...
        <form id="myForm" method="post" action="{{ route('vendor.store.product') }}" enctype="multipart/form-data" >
                ...
                <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product_size" class="form-control visually-hidden" data-role="tagsinput" value="Large,Medium,Small">
                        </div>
                        <div class="mb-3">
                        <label for="inputProductTitle" class="form-label">Product Color</label>
                        <input type="text" name="product_color" class="form-control visually-hidden" data-role="tagsinput" value="Red,Green,Yellow">
                        </div>
                        <div class="mb-3 form-group">
                        ...
                        <textarea id="summernote" name="long_descp">Hello, World!</textarea>
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input class="form-control @error('multi_img')
                                is-invalid
                            @enderror" name="multi_img[]" type="file" id="multiImg"
                                multiple="" max="5">
                                @error('multi_img')
                ...
                $(document).ready(function (){
                    $('#myForm').validate({
                        ...
                        messages :{
                            ...
                            short_descp: {
                                required : 'Please Enter Short Descp',
                            },
                            product_thambnail: {
                                required : 'Please Enter Product Thambnail',
                            },
                            selling_price: {
